...
class GlobalConfig(BaseSettings):
  ...
  # Get Minio Config
  MINIO_HOST: Optional[str] = Field(None, env=Config.env_prefix + 'MINIO_HOST')
  MINIO_ACCESS_KEY: Optional[str] = Field(None, env=Config.env_prefix + 'MINIO_ACCESS_KEY')
  MINIO_SECRET_KEY: Optional[str] = Field(None, env=Config.env_prefix + 'MINIO_SECRET_KEY')
  MINIO_SECURE: Optional[bool] = Field(None, env=Config.env_prefix + 'MINIO_SECURE')

  # Get ElasticSearch Config
  ELASTICSEARCH_HOST: Optional[str] = Field(None, env=Config.env_prefix + 'ELASTICSEARCH_HOST')
  ELASTICSEARCH_PORT: Optional[str] = Field(None, env=Config.env_prefix + 'ELASTICSEARCH_PORT')
  ELASTICSEARCH_INDEX: Optional[str] = Field(None, env=Config.env_prefix + 'ELASTICSEARCH_INDEX')
  ELASTICSEARCH_USERNAME: Optional[str] = Field(None, env=Config.env_prefix + 'ELASTICSEARCH_USERNAME')
  ELASTICSEARCH_PASSWORD: Optional[str] = Field(None, env=Config.env_prefix + 'ELASTICSEARCH_PASSWORD')
